...
lsNumPrue = ['432B','420','430C','430B']
lambAsLS = ['0','0.005','0.0075','0.01']
typeP = 'den15'
...
for k in range(1,25):
	...
	#denoisig25
	namefig = './noisy_15C/noisy_15_kodim'+ str(kodim_num_i) + '.png'
	imgOut = cv2.imread(namefig)
	lsBestImg.append(imgOut)
	...
	lsNames = ['Original','Noisy15','DIP', 'DIP-VTV',' DIP-RiemannVTV', 'DIP-DiracVTV$^{NL}$']
	...
	titulo = './OUTIMG/ImgAng'+typeP +'KODIMnum' + str(kodim_num_i) + '.png'
