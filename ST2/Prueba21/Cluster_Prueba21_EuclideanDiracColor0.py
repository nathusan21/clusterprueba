...
for k in range(1,25):#
    ...
    LAMval = [0,0.01,0.03,0.075,0.1]#,0.0003,0.0005,0.0007]#,0.05,0.075,0.1,0.25,0.5,0.75,1,1.5]
    ...
    for lam in LAMval:
        ...
        full_net =  EuclideanDiracColor(input_depth, dtype, pad, height=img_height, width= img_width, upsample_mode='bilinear', n_channels=3, act_fun='LeakyReLU').type(dtype)
