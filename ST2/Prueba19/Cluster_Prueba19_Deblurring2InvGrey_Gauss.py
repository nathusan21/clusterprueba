...
#    nameimg = 'kodim' + str(k) + '_small.png'
    ...
    for lam in LAMval:
        ...
        full_net = InvariantGreyLevel(input_depth, dtype, pad, luminance, differential_luminance_x,differential_luminance_y, height=img_height, width= img_width, upsample_mode='bilinear', n_channels=1, act_fun='LeakyReLU').type(dtype)
