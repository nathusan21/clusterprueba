...
listaRep =[4,6,11,12,15,16,17,19,20,21,22,23]
...
namefig = './outGraf/' + 'BestImgREP2'+ Nprueb +'p1.png' 
...
namefig = './outGraf/' + 'BestImgREP2'+ Nprueb +'p2.png' 
...
namefig = './outGraf/' + 'BestImgREP2'+ Nprueb +'p3.png' 
...
namefig = './outGraf/' + 'BestImgREP2'+ Nprueb +'E.png' 
...
namefig = './outGraf/' + 'grafPNSRImgREP2'+ Nprueb +'p1.png' 
...
namefig = './outGraf/' + 'grafPNSRImgREP2'+ Nprueb +'p2.png'
...
namefig = './outGraf/' + 'grafPNSRImgREP2'+ Nprueb +'p3.png' 
...
namefig = './outGraf/' + 'grafPNSRImgREP2'+ Nprueb +'E.png' 
...
#plt.legend()
autolabel(grafb)
plt.savefig('./outGraf/freqREP'+ Nprueb +'.png')
...
for i in range(1,4):
    namefig = './outGraf/' + 'grafPNSRImgREP2'+ Nprueb +'p'+str(i)+'.png' 
