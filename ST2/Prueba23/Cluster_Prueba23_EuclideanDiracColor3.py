...
for k in range(1,25):#
    ...
    for lam in LAMval:
        ...
        full_net =  EuclideanDiracColor6(input_depth, dtype, pad, height=img_height, width= img_width, upsample_mode='bilinear').type(dtype)
